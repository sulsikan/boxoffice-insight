...
> 
> 제가 참여했던 프로그래머스 데이터 엔지니어링 데브코스 1차 팀 프로젝트의 기능을 축소하고, AWS 배포를 진행한 축소판 프로젝트입니다.
...
1. **데이터로 영화 성과 간략하게 확인하기**
    ...
    - 기능
        - 영화 목록 제공 : 기본 페이지에서는 국내 박스오피스 상위 200편의 영화 목록을 확인할 수 있습니다.
          ...
          <img width="1452" alt="스크린샷 2025-05-11 오전 1 11 50" src="https://github.com/user-attachments/assets/634e2848-a500-401b-aee5-a381a53aa7e9" />

        - 검색 기능 : 관심 있는 영화를 검색하여 빠르게 찾을 수 있도록 검색 기능을 제공합니다.
  
          <img width="1464" alt="스크린샷 2025-05-11 오전 1 14 37" src="https://github.com/user-attachments/assets/71b54af5-a426-4111-a17c-866093ec64a8" />
          

        - 성과 지표 시각화 : 여기서 개봉 후 10일 동안 `관객 수`와 `스크린 수`, `매출액` 지표를 가져와 어떤 그래프를 띄우는지 한 눈에 볼 수 있습니다.
          <img width="1464" alt="스크린샷 2025-05-11 오전 1 14 57" src="https://github.com/user-attachments/assets/0516e4de-cf27-4edd-9e4f-91ae72e7f12e" />
...
2. **같은 시기 다른 영화들과의 비교**
    ...
    - 기능
        ...
        - 
          <img width="1456" alt="스크린샷 2025-05-11 오전 1 15 22" src="https://github.com/user-attachments/assets/79a6d39e-16ed-4141-a9ac-6ccb3524197c" />
        ...
        - 
          <img width="1449" alt="스크린샷 2025-05-11 오전 1 15 40" src="https://github.com/user-attachments/assets/c196ef4b-16ef-48ad-8247-658d057813e0" />
